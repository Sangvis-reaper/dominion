...
def main():
    ...
    st.markdown('<small>Leverage Google Cloud Vision API to detect landmarks, objects, logos, and web entities from images. Upload an image and get instant intelligence.</small>', unsafe_allow_html=True)

    # Set sidebar title and description
    st.sidebar.title('ℹ️ About')
    st.sidebar.info('GVision is a reverse image search app that uses Google Cloud Vision API to detect landmarks and web entities from images, helping you gather valuable information quickly and easily.')
    st.sidebar.markdown('----')

...
class Hawker:
    def __init__(self):
        ...
        self.folders = {
            'Collection #1':    os.path.join(base_dir, 'database/Collection_#1'),
            'Pornhub':          os.path.join(base_dir, 'database/Pornhub'),
            'Mega.nz':          os.path.join(base_dir, 'database/Mega.nz'),
            'Comcast':          os.path.join(base_dir, 'database/Comcast'),
            'Gmail':            os.path.join(base_dir, 'database/Gmail'),
            'Ogusers':          os.path.join(base_dir, 'database/ogusers.com'),
            'Exploit.in':       os.path.join(base_dir, 'database/Exploit.in'),
            'Instagram':        os.path.join(base_dir, 'database/Instagram')
        }
        self.countries = {
            "FR": os.path.join(base_dir, "camera/FR/camera.txt"),
            "US": os.path.join(base_dir, "camera/US/camera.txt"),
            "RU": os.path.join(base_dir, "camera/RU/camera.txt"),
            "NL": os.path.join(base_dir, "camera/NL/camera.txt"),
            "CA": os.path.join(base_dir, "camera/CA/camera.txt"),
            "IT": os.path.join(base_dir, "camera/IT/camera.txt"),
            "DE": os.path.join(base_dir, "camera/DE/camera.txt"),
            "PL": os.path.join(base_dir, "camera/PL/camera.txt"),
            "SE": os.path.join(base_dir, "camera/SE/camera.txt")
        }
        self.headers = {
            "User-Agent": choice([

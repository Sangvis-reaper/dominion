...
CONFIG_FILE = TELEGRAM_CHECKER_DIR / "config.pkl"
PROFILE_PHOTOS_DIR = TELEGRAM_CHECKER_DIR / "profile_photos"
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(TELEGRAM_CHECKER_DIR / "telegram_checker.log"),
...
class TelegramChecker:
    ...
    async def initialize(self):
        ...
        session_file = TELEGRAM_CHECKER_DIR / 'telegram_checker_session'
    ...
    while True:
        ...
        if choice == "1":
            ...
            if Confirm.ask("Are you sure you want to clear saved credentials?"):
                ...
                session_file = TELEGRAM_CHECKER_DIR / 'telegram_checker_session.session'
